...
export default function FoodPreferences({ setInfoEntered} ) {
  ...
  useEffect(() => {
    ...
    Object.keys(allergens).forEach((preference) => {
      ...
      const preferenceContainer = (
        <View style={styles.preferenceContainer} key={preference}>
  ...
  return (
    <ScrollView style={styles.container}>
        <Text style={styles.header}>Vad är du allergisk mot/har som matpreferens?</Text>
      <View>
      ...
      <View>
        ...
        <View style={styles.addFoodButtonContainer}>
          <TouchableOpacity onPress={addPreferencesToDb} style={styles.addFoodButton}><Text style={styles.addFoodText}>Spara preferenser</Text></TouchableOpacity>
        </View>
      </View>
      {infoSelector != "" && (
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            <Text style={styles.modalDescription}>
              ...
              <TouchableOpacity onPress={() => setInfoSelector(false)} style={styles.closeButton}>
